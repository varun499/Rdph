...
powershell -Command "Invoke-WebRequest https://gitlab.com/gusta7w7/pcrdp-avica/-/raw/main/CachedImage_1024_768_POS4.jpg -OutFile CachedImage_1024_768_POS4.jpg"
